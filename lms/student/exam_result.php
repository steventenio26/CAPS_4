...
<div class="card">
<?php
$qq=mysqli_query($conn, "select * FROM exam LEFT JOIN exam_results on exam.exam_id = exam_results.exam_id
							  where exam.exam_id = '$get_id' and student_id='$session_id'");
...
?>
						  ...
						  <div class="p-2 flex-grow-1 bd-highlight">exam title:&nbsp<?php echo $qt;?></div>
				...
				<?php
							...
							$q=mysqli_query($conn, "select * FROM student_answer_exam LEFT JOIN exam on student_answer_exam.exam_id = exam.exam_id 
 LEFT JOIN Exam_questions on exam_questions.question_id = student_answer_exam.question_id where student_answer_exam.exam_id = '$get_id' and student_id='$session_id'");
