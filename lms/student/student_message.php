		     ...
		     <div class="card direct-chat direct-chat-primary shadow-lg">
               <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="student_message.php" class="btn btn-primary btn-sm">
                    <i class="fas fa-envelope"></i>inbox
                  </a>
                  
                  <a href="sent_message_student.php" class="btn btn-default btn-sm">
				...
				<?php
                  ...
                  <div class="direct-chat-msg">
                    <div class="direct-chat-infos clearfix">
                      <span class="direct-chat-name float-left"><?php echo $row['sender_name']; ?></span>
                      <span class="direct-chat-timestamp float-right"><?php echo $row['date_sended']; ?>-<time class ="timeago" datetime="<?php echo $row['date_sended']; ?>"></time></span>
                    </div>
                    <!-- /.direct-chat-infos -->
					...
					<a href="#" class="link-black text-sm float-right" data-toggle="dropdown"><i class="fa fa-ellipsis-h mr-1"></i>
					<div class="dropdown-menu dropdown-menu-right" role="menu">
                      <a href="#reply<?php echo $id; ?>" class="dropdown-item" data-toggle="modal" data-target="#modal-default">reply</a>
					  <a href="#<?php echo $id; ?>" class="dropdown-item" data-toggle="modal" data-target="#modal-default">remove</a>
                    </div> 
					</a>
                    <!-- /.direct-chat-text -->
                  </div>
