...
<?php
				$query_quiz_list = mysqli_query($conn,"select * from class_quiz where teacher_class_id = '$get_id'")or die(mysqli_error());
				$count_quiz = mysqli_num_rows($query_quiz_list);
				if ($count_quiz > 0){
				?>
            ...
            <main> 
                 ...
                 <table border="0" cellspacing="0" cellpadding="0" >
                    <thead>
                        <tr>
                            <th>No.</th>
                            <th class="text-left">QUIZ TITLE AND DESCRIPTION</th>
                    ...
                    <tbody>
                        ...
                        <tr class="border-bottom">
                            ...
                            <td class="text-left"><h3><strong><?php echo $row['quiz_title']; ?></strong></h3><?php  echo $row['quiz_description']; ?></td>
                            <td class="unit fw-bolder"style="width:240px;"><?php echo "$hours hr and $minutes mins"; ?></td>
							<td style="width:200px;">
							<center>
							<?php if ($count < 1){?> 
							<input type="image" src="../../dist/img/start.svg" class="btntake" value="<?php echo $quiz_id;?>" onclick="set_quiz_type_session(this.value);" style="width:140px; height:;">
...
<script type="text/javascript">
    function set_quiz_type_session(quiz_category)
    {
        ...
        xmlhttp.onreadystatechange=function()
        {
				if(xmlhttp.readyState == 4 && xmlhttp.status == 200)
				{
					...
					Swal.fire({
					  ...
					  confirmButtonText: 'Yes, I will take this quiz'
					}).then((result) => {
							if (result.value) {
        ...
        xmlhttp.open("GET","set_quiz_type_session.php?quiz_category="+ quiz_category,true);
        xmlhttp.send(null);  
        }
</script>
