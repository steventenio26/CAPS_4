            ...
            <div class="border">
                <div class="question bg-white p-3 border-bottom " style="height:80px; ">
                   <div class="d-flex flex-row justify-content-between align-items-center mcq">
					      <?php
							$res1=mysqli_query($conn, "select * FROM class_quiz LEFT JOIN quiz on class_quiz.quiz_id = quiz.quiz_id where quiz.quiz_id = '$_SESSION[quiz_category]'");
							while($row1=mysqli_fetch_array($res1))
							{
						   ?>
						   <h4>Quiz title: <?php echo $row1['quiz_title']; ?></h4>
						   <?php } ?>
...
setInterval(function(){
	...
	{		 	
        ...
        xmlhttp.open("GET","ajax/save_ans_in_session.php?questionno="+ questionno +"&value1="+radiovalue,true);
        xmlhttp.send(null);		
	}
