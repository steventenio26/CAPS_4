...
<div class="container-fluid">
    <div class="row">
        ...
        $sql2 = mysqli_query($conn, "SELECT * FROM exam_questions WHERE exam_id = '$q_id'");
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-light">
              ...
              <li class="breadcrumb-item active" aria-current="page">Exam Score</li>
            </ol>
          </nav>
          </div>
          <div class="container-fluid">
          <div class="alert alert-primary">
              <h6>Students who submit exam in: <?php echo $quizid; ?> </h6>
          </div>
            <table class="table">
          ...
          <?php
            while ($row = mysqli_fetch_array($result)){
                ...
                $sql1="SELECT * FROM exam_results WHERE exam_id = '$q_id' AND student_id = '$stud_id' ";
