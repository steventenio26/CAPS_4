        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-light">
              ...
              <li class="breadcrumb-item"><a href="class_exam.php<?php echo '?id='.$get_id.'&cid='.$class_id; ?>">Class Exam</a></li>
              <li class="breadcrumb-item active" aria-current="page">Exam Item Analysis</li>
            </ol>
          </nav>
          </div>
            <?php
            $result = mysqli_query($conn, "SELECT * FROM exam_results WHERE exam_id = '$quiz_id'");
            $query = mysqli_query($conn,"SELECT * FROM exam_questions WHERE exam_id = '$quiz_id' ");
            $count = mysqli_num_rows($result);
            $dataPoints = array();

            if ($count > 0){ ?>
          <div id="chartContainer1" style="height: 470px; width: 100%;"></div></br></br></br></br>
          <div class="container-fluid">    
        ...
        <?php } ?>
                ...
                <?php }else{ ?>
                    <div class="alert alert-danger">
                        ...
                        Students haven't taken the exam yet</h6>
                    </div>
               <?php } ?>
</div>
