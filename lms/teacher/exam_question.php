          ...
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-light">
                    <li class="breadcrumb-item"><a href="teacher_exam.php">Create Exam</a></li>
            ...
            <div class="tab-content">
                <div id="home" class="tab-pane active"><br>
                    <table class="table text-center">
                        ...
                        <tbody>
                        <?php
                            $query = mysqli_query($conn,"SELECT * FROM exam_questions WHERE exam_id = '$get_id' ");
                            $number = 0;
                        ...
                        ?>
                            ...
                            <?php
                            include "exam_question_modal.php";
                        }?>
                        </tbody>
                    </table>
                </div>
                    ...
                    <form action="action.php?id=<?php echo $get_id;?>" method="post" class="form-group">
                        <div class="row">
                            ...
                            <div class="form-group col-8">
                                ...
                                <button name="save_exam_question" class="btn btn-dark mt-3"><span data-feather="plus-circle"></span> Add Question</button>
                            </div>
                            <div class="col-2"></div>
                        </div>                
                    </form>                    
