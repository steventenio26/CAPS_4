    ...
    <div class="modal-content">
      <form action="" method="post">
        ...
        <div class="modal-body">
            ...
            <h6 class="text-dark text-center"><?php echo $fullname;?></h6>
...
<div class="modal fade" id="delete_quiz<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
    <div class="modal-content">
      <form action="" method="post">
        <div class="modal-header">
        ...
        <div class="modal-body">
            ...
            <h6 class="text-dark text-center"><?php echo $row['quiz_title'];?></h6>
            <input type="hidden" name="id" value="<?php echo $id;?>">
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-outline-light text-secondary" data-dismiss="modal">Cancel</button>
          <button name="delete_quiz" class="btn btn-outline-light text-danger"><span data-feather="trash-2"></span>
          Delete</button>
        </div>
      </form>
  ...
  <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
    <div class="modal-content">
      <form action="action.php?id=<?php echo $question_id.'&quiz_id='.$get_id;?>" method="post">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-outline-light text-secondary" data-dismiss="modal">Cancel</button>
          <button name="delete_question_quiz" class="btn btn-outline-light text-danger"><span data-feather="trash-2"></span>
          Delete</button>
        </div>
      </form>
    ...
    <div class="modal-content">
      ...
      <form action="action.php?id=<?php echo $question_id.'&quiz_id='.$get_id;?>" method="post">
        ...
        <div class="modal-footer">
          ...
          <button name="update_question" class="btn btn-outline-info"><span data-feather="save"></span>
          Save</button>
        </div>
      </form>
    </div>
